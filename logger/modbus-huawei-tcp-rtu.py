...
for x in range(2000000):
    ...
    yield_today = np.int32(np.left_shift(np.int32(response.registers[0]),16) | np.int32(response.registers[1]))/100.0
    ...
    yield_total = np.int32(np.left_shift(np.int32(response.registers[0]),16) | np.int32(response.registers[1]))/100.0
    ...
    ac_c1 = np.int32(np.left_shift(np.int16(response.registers[0]),16) | np.int32(response.registers[1]))/1000.0
    if(ac_c1 != ac_c1_):
        mqtt_client.publish("huawei/ac_c1", payload=ac_c1)
        ac_c1_ = ac_c1
    
    response = client.read_holding_registers(address=32074, count=2, unit=1)
    ac_c2 = np.int32(np.left_shift(np.int16(response.registers[0]),16) | np.int32(response.registers[1]))/1000.0
    if(ac_c2 != ac_c2_):
        mqtt_client.publish("huawei/ac_c2", payload=ac_c2)
        ac_c2_ = ac_c2
    
    response = client.read_holding_registers(address=32076, count=2, unit=1)
    ac_c3 = np.int32(np.left_shift(np.int16(response.registers[0]),16) | np.int32(response.registers[1]))/1000.0
    if(ac_c3 != ac_c3_):
