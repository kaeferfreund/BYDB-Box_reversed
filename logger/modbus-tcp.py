...
for x in range(2000000):
    ...
    if hasattr(response, "registers"):
        # -----------
        #power
        p1 = np.int32(np.left_shift(np.int16(response.registers[0x16]),16) | np.int32(response.registers[0x17])) / 100.0
        p2 = np.int32(np.left_shift(np.int16(response.registers[0x18]),16) | np.int32(response.registers[0x19])) / 100.0
        p3 = np.int32(np.left_shift(np.int16(response.registers[0x1A]),16) | np.int32(response.registers[0x1B])) / 100.0
        psum = np.int32(np.left_shift(np.int16(response.registers[0x14]),16) | np.int32(response.registers[0x15])) / 100.0
    ...
    if hasattr(response, "registers"):
        # energy forward
        ef = (np.left_shift(response.registers[0x00],48) | np.left_shift(response.registers[0x01],32) | np.left_shift(response.registers[0x02],16) | response.registers[0x03]) / 100.0
        ee = (np.left_shift(response.registers[0x04],48) | np.left_shift(response.registers[0x05],32) | np.left_shift(response.registers[0x06],16) | response.registers[0x07]) / 100.0
    ...
    if hasattr(response, "registers"):
        ...
        ef1 = (np.left_shift(response.registers[0x0],48) | np.left_shift(response.registers[0x01],32) | np.left_shift(response.registers[0x02],16) | response.registers[0x03]) / 100.0
        ef2 = (np.left_shift(response.registers[0x04],48) | np.left_shift(response.registers[0x05],32) | np.left_shift(response.registers[0x06],16) | response.registers[0x07]) / 100.0
        ef3 = (np.left_shift(response.registers[0x08],48) | np.left_shift(response.registers[0x09],32) | np.left_shift(response.registers[0x0A],16) | response.registers[0x0B]) / 100.0
        ...
        ee3 = (np.left_shift(response.registers[0x14],48) | np.left_shift(response.registers[0x15],32) | np.left_shift(response.registers[0x16],16) | response.registers[0x17]) / 100.0
